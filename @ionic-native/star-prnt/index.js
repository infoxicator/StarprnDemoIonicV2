...
var StarPRNT = (function (_super) {
    ...
    */
    StarPRNT.prototype.portDiscovery = function (type) { return; };
    /**
      ...
      */
    StarPRNT.prototype.checkStatus = function (port, emulation) { return; };
    /**
     * Prints plain text
     ...
     */
    StarPRNT.prototype.printRawText = function (port, emulation, printObj) { return; };
    /**
     ...
     * @return {Promise<any>} Success! if printed correctly or error message string returned by the SDK.
     */
    StarPRNT.prototype.printRasterReceipt = function (port, emulation, rasterObj) { return; };
    /**
     ...
     * @return {Promise<any>} Success! if printed correctly or error message string returned by the SDK.
     */
    StarPRNT.prototype.printImage = function (port, emulation, imageObj) { return; };
    /**
     ...
     */
    StarPRNT.prototype.openCashDrawer = function (port, emulation) { return; };
    /**
 ...
 * @return {Promise<any>} Success! if printed correctly or error message string returned by the SDK.
 */
    StarPRNT.prototype.print = function (port, emulation, commandsArray) { return; };
    /**
    ...
    */
    StarPRNT.prototype.connect = function (port, emulation) { return; };
    /**
    ...
    */
    StarPRNT.prototype.getStatus = function () { return; };
    /**
     ...
     */
    StarPRNT.prototype.disconnect = function () { return; };
    StarPRNT.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    ...
    StarPRNT = __decorate([
        Plugin({
            ...
            pluginRef: 'starprnt',
            repo: 'https://github.com/infoxicator/starprnt',
            install: '',
            installVariables: [],
